...
export class FleetService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createShipWaypointScan(shipSymbol: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CreateShipWaypointScan201Response>;
    public createShipWaypointScan(shipSymbol: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CreateShipWaypointScan201Response>>;
    public createShipWaypointScan(shipSymbol: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CreateShipWaypointScan201Response>>;
    public createShipWaypointScan(shipSymbol: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (shipSymbol === null || shipSymbol === undefined) {
            throw new Error('Required parameter shipSymbol was null or undefined when calling createShipWaypointScan.');
        }
        ...
        let localVarPath = `/my/ships/${this.configuration.encodeParam({name: "shipSymbol", value: shipSymbol, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/scan/waypoints`;
        return this.httpClient.request<CreateShipWaypointScan201Response>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMyShips(page?: number, limit?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetMyShips200Response>;
    public getMyShips(page?: number, limit?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetMyShips200Response>>;
    public getMyShips(page?: number, limit?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetMyShips200Response>>;
    public getMyShips(page?: number, limit?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
