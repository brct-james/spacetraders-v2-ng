...
export class AgentsService {
     ...
     */
    public getMyAgent(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<GetMyAgent200Response>;
    public getMyAgent(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<GetMyAgent200Response>>;
    public getMyAgent(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<GetMyAgent200Response>>;
    public getMyAgent(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/my/agent`;
        return this.httpClient.request<GetMyAgent200Response>('get', `${this.configuration.basePath}${localVarPath}`,
            {
