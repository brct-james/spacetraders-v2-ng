...
export interface RegisterRequest { 
     ...
     */
    faction: RegisterRequest.FactionEnum;
    /**
...
export namespace RegisterRequest {
    export type FactionEnum = 'COSMIC' | 'VOID' | 'GALLACTIC' | 'QUANTUM' | 'DOMINION' | 'ASTRO' | 'CORSAIRS' | 'UNITED' | 'SOLITARY' | 'COBALT';
    export const FactionEnum = {
        Cosmic: 'COSMIC' as FactionEnum,
        Void: 'VOID' as FactionEnum,
        Gallactic: 'GALLACTIC' as FactionEnum,
        Quantum: 'QUANTUM' as FactionEnum,
        Dominion: 'DOMINION' as FactionEnum,
        Astro: 'ASTRO' as FactionEnum,
        Corsairs: 'CORSAIRS' as FactionEnum,
        United: 'UNITED' as FactionEnum,
        Solitary: 'SOLITARY' as FactionEnum,
        Cobalt: 'COBALT' as FactionEnum
    };
}
